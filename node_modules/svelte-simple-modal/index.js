	...
	return {
		...
		m(target, anchor) {
			...
			dispose = [
				...
				listen(div3, "click", /*handleOuterClick*/ ctx[16])
			];
		},
		p(new_ctx, dirty) {
			ctx = new_ctx;
...
function create_if_block_1(ctx) {
	...
	return {
		...
		m(target, anchor) {
			...
			dispose = listen(button, "click", /*close*/ ctx[14]);
		},
		p: noop,
		d(detaching) {
...
function create_fragment(ctx) {
	...
	return {
		...
		m(target, anchor) {
			...
			current = true;
			dispose = listen(window, "keyup", /*handleKeyup*/ ctx[15]);
		},
		p(ctx, dirty) {
			if (/*Component*/ ctx[1]) {
				if (if_block) {
			...
			if (default_slot && default_slot.p && dirty[1] & /*$$scope*/ 8) {
...
function instance($$self, $$props, $$invalidate) {
	...
	let { setContext = svelte.setContext } = $$props;
	...
	$$self.$set = $$props => {
		...
		if ("setContext" in $$props) $$invalidate(24, setContext = $$props.setContext);
