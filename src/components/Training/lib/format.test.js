...
describe("training formatters", () => {
	...
	it("rounds a projected finish to the minute rather than implying second precision", () => {
		expect(clockMinutes(11894.4)).toBe("3:18");
		expect(clockMinutes(12780)).toBe("3:33");
