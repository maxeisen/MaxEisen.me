...
var app = (function () {
    ...
    /* src\components\Profile.svelte generated by Svelte v3.24.1 */
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h21, file$7, 20, 0, 803);
    			...
    			add_location(a0, file$7, 22, 4, 884);
    			...
    			add_location(a1, file$7, 23, 4, 1043);
    			...
    			add_location(a2, file$7, 24, 4, 1191);
    			...
    			add_location(a3, file$7, 25, 4, 1343);
    			attr_dev(div0, "class", "social-links-container svelte-t07b25");
    			add_location(div0, file$7, 21, 0, 842);
    			...
    			add_location(source0, file$7, 30, 8, 1527);
    			...
    			add_location(source1, file$7, 31, 8, 1612);
    			...
    			add_location(img, file$7, 32, 8, 1695);
    			add_location(picture, file$7, 29, 4, 1508);
    			attr_dev(div1, "class", "headshot svelte-t07b25");
    			add_location(div1, file$7, 28, 0, 1480);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
