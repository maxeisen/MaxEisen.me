...
var app = (function () {
    ...
    // (20:0) <Annotation bind:visible type="highlight" color="rgba(0, 187, 162, 0.23)">
    function create_default_slot$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$6, 19, 74, 703);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(20:0) <Annotation bind:visible type=\\\"highlight\\\" color=\\\"rgba(0, 187, 162, 0.23)\\\">",
    		ctx
    	});
    ...
    function create_fragment$e(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(li2, file$e, 5, 8, 145);
    			attr_dev(li3, "class", "svelte-19idqw3");
    			add_location(li3, file$e, 6, 8, 173);
    			...
    			add_location(li9, file$e, 12, 8, 303);
    			attr_dev(li10, "class", "svelte-19idqw3");
    			add_location(li10, file$e, 13, 8, 327);
    			attr_dev(li11, "class", "svelte-19idqw3");
    			add_location(li11, file$e, 14, 8, 351);
    			attr_dev(li12, "class", "svelte-19idqw3");
    			add_location(li12, file$e, 15, 8, 375);
    			attr_dev(li13, "class", "svelte-19idqw3");
    			add_location(li13, file$e, 16, 8, 397);
    			attr_dev(li14, "class", "svelte-19idqw3");
    			add_location(li14, file$e, 17, 8, 418);
    ...
    function create_default_slot$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$g, 14, 25, 520);
    			attr_dev(a0, "href", "/#");
    			add_location(a0, file$g, 14, 12, 507);
    			add_location(div0, file$g, 13, 8, 489);
    			attr_dev(a1, "href", "#experience");
    			add_location(a1, file$g, 19, 24, 720);
    			add_location(li0, file$g, 19, 20, 716);
    			attr_dev(a2, "href", "#projects");
    			add_location(a2, file$g, 20, 24, 786);
    			add_location(li1, file$g, 20, 20, 782);
    			attr_dev(a3, "href", "#education");
    			add_location(a3, file$g, 21, 24, 848);
    			add_location(li2, file$g, 21, 20, 844);
    			attr_dev(a4, "href", "#skills");
    			add_location(a4, file$g, 22, 24, 912);
    			add_location(li3, file$g, 22, 20, 908);
    			add_location(b0, file$g, 23, 42, 988);
    			attr_dev(a5, "href", "/resume");
    			add_location(a5, file$g, 23, 24, 970);
    			add_location(li4, file$g, 23, 20, 966);
    			add_location(ul, file$g, 18, 16, 691);
    			add_location(nav, file$g, 17, 12, 669);
    			attr_dev(div1, "class", "nav-bar");
    			add_location(div1, file$g, 16, 8, 635);
    			add_location(header, file$g, 12, 4, 472);
    			attr_dev(div2, "class", "sidebar-section");
    			add_location(div2, file$g, 29, 8, 1122);
    			attr_dev(div3, "class", "info-section-inner");
    			add_location(div3, file$g, 33, 12, 1242);
    			set_style(b1, "font-size", "14px");
    			set_style(b1, "color", "#ababab");
    			add_location(b1, file$g, 40, 113, 1545);
    			attr_dev(h2, "class", "footer");
    			add_location(h2, file$g, 40, 63, 1495);
    			attr_dev(a6, "href", "https://github.com/maxeisen/MaxEisen.me/");
    			add_location(a6, file$g, 40, 12, 1444);
    			attr_dev(div4, "class", "info-section-main");
    			add_location(div4, file$g, 32, 8, 1198);
    			attr_dev(div5, "class", "grid-container");
    			add_location(div5, file$g, 28, 4, 1085);
    		},
    		m: function mount(target, anchor) {
