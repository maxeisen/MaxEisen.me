...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file, 21, 16, 887);
    			...
    			add_location(source0, file, 23, 20, 1166);
    			...
    			add_location(source1, file, 24, 20, 1276);
    			...
    			add_location(video, file, 22, 16, 1036);
    			attr_dev(a0, "href", "/#");
    			...
    			add_location(a1, file, 31, 42, 1589);
    			attr_dev(li0, "id", "nav-bar-item");
    			add_location(li0, file, 31, 20, 1567);
    			attr_dev(a2, "href", "#projects");
    			add_location(a2, file, 32, 42, 1674);
    			attr_dev(li1, "id", "nav-bar-item");
    			add_location(li1, file, 32, 20, 1652);
    			attr_dev(a3, "href", "#blog");
    			add_location(a3, file, 33, 42, 1755);
    			attr_dev(li2, "id", "nav-bar-item");
    			add_location(li2, file, 33, 20, 1733);
    			attr_dev(a4, "href", "#education");
    			add_location(a4, file, 34, 42, 1828);
    			attr_dev(li3, "id", "nav-bar-item");
    			add_location(li3, file, 34, 20, 1806);
    			attr_dev(a5, "href", "#skills");
    			add_location(a5, file, 35, 42, 1911);
    			attr_dev(li4, "id", "nav-bar-item");
    			add_location(li4, file, 35, 20, 1889);
    			add_location(b, file, 36, 60, 2006);
    			attr_dev(a6, "href", "/resume");
    			add_location(a6, file, 36, 42, 1988);
    			attr_dev(li5, "id", "nav-bar-item");
    			add_location(li5, file, 36, 20, 1966);
    			attr_dev(ul, "class", "nav-bar-list");
    			attr_dev(ul, "id", "nav-bar-list");
    			add_location(ul, file, 30, 16, 1502);
    			add_location(nav, file, 29, 12, 1479);
    			attr_dev(div1, "class", "nav-bar");
    			attr_dev(div1, "id", "nav-bar");
    			add_location(div1, file, 28, 8, 1431);
    ...
    function create_fragment$a(ctx) {
    	...
    	let t6;
    	let div1;
    	let raw_value = marked(/*postContent*/ ctx[3]) + "";
    	let t7;
    	let div2;
    	let h2;
    	let b1;
    	let t9_value = /*author*/ ctx[1].split(" ")[0] + "";
    	let t9;
    	let t10;
    	let applause_button;
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "blog-title svelte-1eai1od");
    			set_style(h1, "text-align", "center");
    			add_location(h1, file$a, 22, 8, 538);
    			attr_dev(b0, "class", "author-name svelte-1eai1od");
    			add_location(b0, file$a, 23, 67, 669);
    			attr_dev(h30, "class", "blog-author svelte-1eai1od");
    			set_style(h30, "text-align", "center");
    			add_location(h30, file$a, 23, 8, 610);
    			attr_dev(h31, "class", "blog-date svelte-1eai1od");
    			set_style(h31, "text-align", "center");
    			add_location(h31, file$a, 24, 8, 719);
    			attr_dev(div0, "class", "blog-header svelte-1eai1od");
    			add_location(div0, file$a, 21, 4, 503);
    			attr_dev(div1, "class", "blog-content svelte-1eai1od");
    			add_location(div1, file$a, 26, 4, 797);
    			set_style(b1, "font-weight", "300");
    			add_location(b1, file$a, 28, 30, 919);
    			attr_dev(h2, "class", "signature svelte-1eai1od");
    			add_location(h2, file$a, 28, 8, 897);
    			set_custom_element_data(applause_button, "url", /*postUrl*/ ctx[4]);
    			set_custom_element_data(applause_button, "multiclap", "true");
    			set_custom_element_data(applause_button, "color", "var(--main-green)");
    			set_custom_element_data(applause_button, "class", "svelte-1eai1od");
    			add_location(applause_button, file$a, 29, 8, 989);
    			attr_dev(div2, "class", "blog-footer svelte-1eai1od");
    			add_location(div2, file$a, 27, 4, 862);
    			attr_dev(div3, "class", "blog-modal svelte-1eai1od");
    			add_location(div3, file$a, 20, 0, 473);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*postContent*/ 8 && raw_value !== (raw_value = marked(/*postContent*/ ctx[3]) + "")) div1.innerHTML = raw_value;			if (dirty & /*author*/ 2 && t9_value !== (t9_value = /*author*/ ctx[1].split(" ")[0] + "")) set_data_dev(t9, t9_value);
    		},
    		i: noop,
    		o: noop,
    		d: function destroy(detaching) {
    ...
    function instance$a($$self, $$props, $$invalidate) {
    	...
    	fetch(`../content/blog/${content}.md`).then(content => content.text()).then(data => {
    		$$invalidate(3, postContent = data);
    	});

    	const writable_props = ["id", "title", "author", "date", "content"];
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("date" in $$props) $$invalidate(2, date = $$props.date);
    		if ("content" in $$props) $$invalidate(6, content = $$props.content);
    		if ("postContent" in $$props) $$invalidate(3, postContent = $$props.postContent);
    	};
    	...
    	return [title, author, date, postContent, postUrl, id, content];
    }
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h20, file$c, 59, 16, 2358);
    			attr_dev(h21, "class", "blog-date svelte-1ejqdqo");
    			add_location(h21, file$c, 60, 16, 2415);
    			attr_dev(h22, "class", "blog-description svelte-1ejqdqo");
    			add_location(h22, file$c, 61, 16, 2471);
    			attr_dev(div, "class", "blog-item");
    			attr_dev(div, "tabindex", "0");
    			add_location(div, file$c, 58, 12, 2210);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, h20);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(58:8) {#if post.published == true}",
    		ctx
    	});
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(57:4) {#each blogPosts as post}",
    		ctx
    	});
    ...
    function create_fragment$c(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$c, 54, 0, 2025);
    			attr_dev(div, "class", "blog-subsection");
    			add_location(div, file$c, 55, 0, 2098);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$c($$self, $$props, $$invalidate) {
    	...
    	const blogPostModal = (postId, title, author, date, content) => {
    		open(
    			BlogPostModal,
    			{ id: postId, title, author, date, content },
    			{
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(h3, "text-align", "center");
    			add_location(h3, file$d, 16, 8, 634);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h3, "class", "modal-description svelte-1uko5iu");
    			set_style(h3, "text-align", "center");
    			add_location(h3, file$d, 14, 8, 528);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h3, anchor);
    			append_dev(h3, t0);
    ...
    function create_if_block$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "rel", "noreferrer");
    			attr_dev(a, "target", "_blank");
    			add_location(a, file$h, 18, 12, 651);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$i(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(h1, "text-align", "left");
    			add_location(h1, file$i, 15, 0, 576);
    			attr_dev(div, "class", "project-subsection");
    			add_location(div, file$i, 16, 0, 657);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$l(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(li0, file$l, 3, 8, 128);
    			attr_dev(li1, "class", "svelte-1vlexz");
    			add_location(li1, file$l, 4, 8, 153);
    			attr_dev(li2, "class", "svelte-1vlexz");
    			add_location(li2, file$l, 5, 8, 176);
    			attr_dev(li3, "class", "svelte-1vlexz");
    			add_location(li3, file$l, 6, 8, 205);
    			attr_dev(li4, "class", "svelte-1vlexz");
    			add_location(li4, file$l, 7, 8, 229);
    			attr_dev(li5, "class", "svelte-1vlexz");
    			add_location(li5, file$l, 8, 8, 252);
    			attr_dev(li6, "class", "svelte-1vlexz");
    			add_location(li6, file$l, 9, 8, 274);
    			attr_dev(li7, "class", "svelte-1vlexz");
    			add_location(li7, file$l, 10, 8, 296);
    			attr_dev(li8, "class", "svelte-1vlexz");
    			add_location(li8, file$l, 11, 8, 317);
    			attr_dev(li9, "class", "svelte-1vlexz");
    			add_location(li9, file$l, 12, 8, 341);
    			attr_dev(li10, "class", "svelte-1vlexz");
    			add_location(li10, file$l, 13, 8, 366);
    			attr_dev(li11, "class", "svelte-1vlexz");
    			add_location(li11, file$l, 14, 8, 391);
    			attr_dev(li12, "class", "svelte-1vlexz");
    			add_location(li12, file$l, 15, 8, 416);
    			attr_dev(li13, "class", "svelte-1vlexz");
    			add_location(li13, file$l, 16, 8, 439);
    			attr_dev(li14, "class", "svelte-1vlexz");
    			add_location(li14, file$l, 17, 8, 461);
    			attr_dev(li15, "class", "svelte-1vlexz");
    			add_location(li15, file$l, 18, 8, 483);
    			attr_dev(ul, "class", "svelte-1vlexz");
    			add_location(ul, file$l, 2, 4, 114);
    			attr_dev(div, "class", "skills-subsection");
    			add_location(div, file$l, 1, 0, 77);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
