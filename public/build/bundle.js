    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(source0, file, 23, 20, 1139);
    			...
    			add_location(source1, file, 24, 20, 1249);
    			...
    			add_location(video, file, 22, 16, 1009);
    			attr_dev(a0, "href", "/#");
    			...
    			add_location(a1, file, 31, 42, 1562);
    			attr_dev(li0, "id", "nav-bar-item");
    			add_location(li0, file, 31, 20, 1540);
    			attr_dev(a2, "href", "#projects");
    			add_location(a2, file, 32, 42, 1647);
    			attr_dev(li1, "id", "nav-bar-item");
    			add_location(li1, file, 32, 20, 1625);
    			attr_dev(a3, "href", "#blog");
    			add_location(a3, file, 33, 42, 1728);
    			attr_dev(li2, "id", "nav-bar-item");
    			add_location(li2, file, 33, 20, 1706);
    			attr_dev(a4, "href", "#education");
    			add_location(a4, file, 34, 42, 1801);
    			attr_dev(li3, "id", "nav-bar-item");
    			add_location(li3, file, 34, 20, 1779);
    			attr_dev(a5, "href", "#skills");
    			add_location(a5, file, 35, 42, 1884);
    			attr_dev(li4, "id", "nav-bar-item");
    			add_location(li4, file, 35, 20, 1862);
    			add_location(b, file, 36, 60, 1979);
    			attr_dev(a6, "href", "/resume");
    			add_location(a6, file, 36, 42, 1961);
    			attr_dev(li5, "id", "nav-bar-item");
    			add_location(li5, file, 36, 20, 1939);
    			attr_dev(ul, "class", "nav-bar-list");
    			attr_dev(ul, "id", "nav-bar-list");
    			add_location(ul, file, 30, 16, 1475);
    			add_location(nav, file, 29, 12, 1452);
    			attr_dev(div1, "class", "nav-bar");
    			attr_dev(div1, "id", "nav-bar");
    			add_location(div1, file, 28, 8, 1404);
