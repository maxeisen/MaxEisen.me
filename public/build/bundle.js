    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(source0, file, 22, 20, 1017);
    			...
    			add_location(source1, file, 23, 20, 1127);
    			...
    			add_location(video, file, 21, 16, 887);
    			attr_dev(a0, "href", "/#");
    			...
    			add_location(a1, file, 30, 42, 1440);
    			attr_dev(li0, "id", "nav-bar-item");
    			add_location(li0, file, 30, 20, 1418);
    			...
    			add_location(nav, file, 28, 12, 1330);
    			attr_dev(div1, "class", "nav-bar");
    			attr_dev(div1, "id", "nav-bar");
    			add_location(div1, file, 27, 8, 1282);
