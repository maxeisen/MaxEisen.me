    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(source0, file, 23, 20, 1128);
    			...
    			add_location(source1, file, 24, 20, 1238);
    			...
    			add_location(video, file, 22, 16, 998);
    			attr_dev(a0, "href", "/#");
    			...
    			add_location(a1, file, 31, 42, 1551);
    			attr_dev(li0, "id", "nav-bar-item");
    			add_location(li0, file, 31, 20, 1529);
    			attr_dev(a2, "href", "#projects");
    			add_location(a2, file, 32, 42, 1636);
    			attr_dev(li1, "id", "nav-bar-item");
    			add_location(li1, file, 32, 20, 1614);
    			attr_dev(a3, "href", "#education");
    			add_location(a3, file, 33, 42, 1717);
    			attr_dev(li2, "id", "nav-bar-item");
    			add_location(li2, file, 33, 20, 1695);
    			attr_dev(a4, "href", "#skills");
    			add_location(a4, file, 34, 42, 1800);
    			attr_dev(li3, "id", "nav-bar-item");
    			add_location(li3, file, 34, 20, 1778);
    			add_location(b, file, 35, 60, 1895);
    			attr_dev(a5, "href", "/resume");
    			add_location(a5, file, 35, 42, 1877);
    			attr_dev(li4, "id", "nav-bar-item");
    			add_location(li4, file, 35, 20, 1855);
    			attr_dev(ul, "class", "nav-bar-list");
    			attr_dev(ul, "id", "nav-bar-list");
    			add_location(ul, file, 30, 16, 1464);
    			add_location(nav, file, 29, 12, 1441);
    			attr_dev(div1, "class", "nav-bar");
    			attr_dev(div1, "id", "nav-bar");
    			add_location(div1, file, 28, 8, 1393);
    ...
    function create_default_slot$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$l, 17, 8, 694);
    			attr_dev(div1, "class", "info-section-inner");
    			add_location(div1, file$l, 21, 12, 814);
    			attr_dev(div2, "class", "info-section-main");
    			add_location(div2, file$l, 20, 8, 770);
    			attr_dev(div3, "class", "grid-container");
    			add_location(div3, file$l, 16, 4, 657);
    		},
    		m: function mount(target, anchor) {
