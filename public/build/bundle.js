    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div = element("div");
    			p0 = element("p");
    			t2 = text("and I am a Computer Science student at ");
    			a0 = element("a");
    			a0.textContent = "Queen's University";
    			t4 = text(" with a fascination for technology.");
    			t5 = space();
    			p1 = element("p");
    			p1.textContent = "I am also a computational thinker who enjoys programming, software and web development, beta testing, automation, and UI/UX design. In my free time, you can find me skiing, hiking, travelling, playing guitar, and trying new tech.";
    			t7 = space();
    			p2 = element("p");
    			p2.textContent = "Although I spend a fair amount of time in front of a computer, I am also a social person who prefers to work with, and be around others. Whether with a project team, a customer, a supervisor, or friends, I strive to communicate effectively and confidently.";
    			t9 = space();
    			p3 = element("p");
    			t10 = text("Feel free to explore my website, click on things for more information, and ");
    			a1 = element("a");
    			a1.textContent = "email me";
    			t12 = text(" if you have any questions or comments.");
    			attr_dev(h1, "class", "section-title-intro svelte-nem28q");
    			add_location(h1, file$6, 3, 0, 20);
    			attr_dev(a0, "class", "intro-link svelte-nem28q");
    			attr_dev(a0, "href", "https://www.queensu.ca/");
    			attr_dev(a0, "target", "_blank");
    			add_location(a0, file$6, 5, 70, 181);
    			attr_dev(p0, "class", "title-extension svelte-nem28q");
    			add_location(p0, file$6, 5, 4, 115);
    			add_location(p1, file$6, 6, 4, 316);
    			add_location(p2, file$6, 7, 4, 557);
    			attr_dev(a1, "class", "intro-link svelte-nem28q");
    			attr_dev(a1, "href", "mailto:max.eisen@queensu.ca");
    			attr_dev(a1, "target", "_blank");
    			add_location(a1, file$6, 8, 82, 903);
    			add_location(p3, file$6, 8, 4, 825);
    			attr_dev(div, "class", "intro-paragraph svelte-nem28q");
    ...
    function create_default_slot$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$f, 16, 29, 550);
    			attr_dev(a0, "href", "/#");
    			add_location(a0, file$f, 16, 16, 537);
    			add_location(div0, file$f, 15, 12, 515);
    			attr_dev(a1, "href", "#experience");
    			add_location(a1, file$f, 21, 28, 770);
    			add_location(li0, file$f, 21, 24, 766);
    			attr_dev(a2, "href", "#projects");
    			add_location(a2, file$f, 22, 28, 840);
    			add_location(li1, file$f, 22, 24, 836);
    			attr_dev(a3, "href", "#education");
    			add_location(a3, file$f, 23, 28, 906);
    			add_location(li2, file$f, 23, 24, 902);
    			attr_dev(a4, "href", "#skills");
    			add_location(a4, file$f, 24, 28, 974);
    			add_location(li3, file$f, 24, 24, 970);
    			add_location(b0, file$f, 25, 46, 1054);
    			attr_dev(a5, "href", "/resume");
    			add_location(a5, file$f, 25, 28, 1036);
    			add_location(li4, file$f, 25, 24, 1032);
    			add_location(ul, file$f, 20, 20, 737);
    			add_location(nav, file$f, 19, 16, 711);
    			attr_dev(div1, "class", "nav-bar");
    			add_location(div1, file$f, 18, 12, 673);
    			add_location(header, file$f, 14, 8, 494);
    			attr_dev(div2, "class", "sidebar-section");
    			add_location(div2, file$f, 31, 12, 1212);
    			attr_dev(div3, "class", "info-section-inner");
    			add_location(div3, file$f, 35, 16, 1348);
    			set_style(b1, "font-size", "14px");
    			set_style(b1, "color", "#ababab");
    			add_location(b1, file$f, 42, 117, 1679);
    			attr_dev(h2, "class", "footer");
    			add_location(h2, file$f, 42, 67, 1629);
    			attr_dev(a6, "href", "https://github.com/maxeisen/MaxEisen.me/");
    			add_location(a6, file$f, 42, 16, 1578);
    			attr_dev(div4, "class", "info-section-main");
    			add_location(div4, file$f, 34, 12, 1300);
    			attr_dev(div5, "class", "grid-container");
    			add_location(div5, file$f, 30, 8, 1171);
    			add_location(body, file$f, 13, 4, 479);
    			attr_dev(html, "lang", "en");
    			add_location(html, file$f, 12, 0, 458);
    		},
    		m: function mount(target, anchor) {
