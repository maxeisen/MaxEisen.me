    ...
    function create_default_slot$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$f, 16, 29, 554);
    			attr_dev(a0, "href", "/#");
    			add_location(a0, file$f, 16, 16, 541);
    			add_location(div0, file$f, 15, 12, 519);
    			attr_dev(a1, "href", "#experience");
    			add_location(a1, file$f, 21, 28, 774);
    			add_location(li0, file$f, 21, 24, 770);
    			attr_dev(a2, "href", "#projects");
    			add_location(a2, file$f, 22, 28, 844);
    			add_location(li1, file$f, 22, 24, 840);
    			attr_dev(a3, "href", "#education");
    			add_location(a3, file$f, 23, 28, 910);
    			add_location(li2, file$f, 23, 24, 906);
    			attr_dev(a4, "href", "#skills");
    			add_location(a4, file$f, 24, 28, 978);
    			add_location(li3, file$f, 24, 24, 974);
    			add_location(b0, file$f, 25, 46, 1058);
    			attr_dev(a5, "href", "/resume");
    			add_location(a5, file$f, 25, 28, 1040);
    			add_location(li4, file$f, 25, 24, 1036);
    			add_location(ul, file$f, 20, 20, 741);
    			add_location(nav, file$f, 19, 16, 715);
    			attr_dev(div1, "class", "nav-bar");
    			add_location(div1, file$f, 18, 12, 677);
    			add_location(header, file$f, 14, 8, 498);
    			attr_dev(div2, "class", "sidebar-section");
    			add_location(div2, file$f, 31, 12, 1216);
    			attr_dev(div3, "class", "info-section-inner");
    			add_location(div3, file$f, 35, 16, 1352);
    			set_style(b1, "font-size", "14px");
    			set_style(b1, "color", "#ababab");
    			add_location(b1, file$f, 42, 117, 1683);
    			attr_dev(h2, "class", "footer");
    			add_location(h2, file$f, 42, 67, 1633);
    			attr_dev(a6, "href", "https://github.com/maxeisen/MaxEisen.me/");
    			add_location(a6, file$f, 42, 16, 1582);
    			attr_dev(div4, "class", "info-section-main");
    			add_location(div4, file$f, 34, 12, 1304);
    			attr_dev(div5, "class", "grid-container");
    			add_location(div5, file$f, 30, 8, 1175);
    			add_location(body, file$f, 13, 4, 483);
    			attr_dev(html, "lang", "en");
    			add_location(html, file$f, 12, 0, 462);
    		},
    		m: function mount(target, anchor) {
