    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			b1.textContent = "-";
    			t9 = text(t9_value);
    			attr_dev(h1, "class", "blog-title svelte-5yutmj");
    			set_style(h1, "text-align", "center");
    			add_location(h1, file$a, 20, 8, 413);
    			attr_dev(b0, "class", "author-name svelte-5yutmj");
    			add_location(b0, file$a, 21, 67, 543);
    			attr_dev(h30, "class", "blog-author svelte-5yutmj");
    			set_style(h30, "text-align", "center");
    			add_location(h30, file$a, 21, 8, 484);
    			attr_dev(h31, "class", "blog-date svelte-5yutmj");
    			set_style(h31, "text-align", "center");
    			add_location(h31, file$a, 22, 8, 592);
    			attr_dev(div0, "class", "blog-header svelte-5yutmj");
    			add_location(div0, file$a, 19, 4, 379);
    			attr_dev(div1, "class", "blog-content svelte-5yutmj");
    			add_location(div1, file$a, 24, 4, 668);
    			set_style(b1, "font-weight", "300");
    			add_location(b1, file$a, 25, 26, 754);
    			attr_dev(h2, "class", "signature svelte-5yutmj");
    			add_location(h2, file$a, 25, 4, 732);
    			attr_dev(div2, "class", "blog-modal svelte-5yutmj");
    			add_location(div2, file$a, 18, 0, 350);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h20, file$c, 55, 12, 2018);
    			attr_dev(h21, "class", "blog-date svelte-1ejqdqo");
    			add_location(h21, file$c, 56, 12, 2070);
    			attr_dev(h22, "class", "blog-description svelte-1ejqdqo");
    			add_location(h22, file$c, 57, 12, 2121);
    			attr_dev(div, "class", "blog-item");
    			attr_dev(div, "tabindex", "0");
    			add_location(div, file$c, 54, 8, 1875);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, h20);
    ...
    function create_fragment$c(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$c, 51, 0, 1735);
    			attr_dev(div, "class", "blog-subsection");
    			add_location(div, file$c, 52, 0, 1807);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
