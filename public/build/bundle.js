...
var app = (function () {
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			b1.textContent = "-";
    			t9 = text(t9_value);
    			attr_dev(h1, "class", "blog-title svelte-18wqprn");
    			set_style(h1, "text-align", "center");
    			add_location(h1, file$a, 20, 8, 433);
    			attr_dev(b0, "class", "author-name svelte-18wqprn");
    			add_location(b0, file$a, 21, 67, 564);
    			attr_dev(h30, "class", "blog-author svelte-18wqprn");
    			set_style(h30, "text-align", "center");
    			add_location(h30, file$a, 21, 8, 505);
    			attr_dev(h31, "class", "blog-date svelte-18wqprn");
    			set_style(h31, "text-align", "center");
    			add_location(h31, file$a, 22, 8, 614);
    			attr_dev(div0, "class", "blog-header svelte-18wqprn");
    			add_location(div0, file$a, 19, 4, 398);
    			attr_dev(div1, "class", "blog-content svelte-18wqprn");
    			add_location(div1, file$a, 24, 4, 692);
    			set_style(b1, "font-weight", "300");
    			add_location(b1, file$a, 25, 26, 779);
    			attr_dev(h2, "class", "signature svelte-18wqprn");
    			add_location(h2, file$a, 25, 4, 757);
    			attr_dev(div2, "class", "blog-modal svelte-18wqprn");
    			add_location(div2, file$a, 18, 0, 368);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$a($$self, $$props, $$invalidate) {
    	...
    	return [title, author, date, postContent, content];
    }

    class BlogPostModal extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$a, create_fragment$a, safe_not_equal, { title: 0, author: 1, date: 2, content: 4 });
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h20, file$c, 53, 12, 1956);
    			attr_dev(h21, "class", "blog-date svelte-1ejqdqo");
    			add_location(h21, file$c, 54, 12, 2009);
    			attr_dev(h22, "class", "blog-description svelte-1ejqdqo");
    			add_location(h22, file$c, 55, 12, 2061);
    			attr_dev(div, "class", "blog-item");
    			attr_dev(div, "tabindex", "0");
    			add_location(div, file$c, 52, 8, 1812);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, h20);
    ...
    function create_fragment$c(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$c, 49, 0, 1669);
    			attr_dev(div, "class", "blog-subsection");
    			add_location(div, file$c, 50, 0, 1742);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
