    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(b, file$7, 20, 22, 778);
    			attr_dev(h20, "class", "status svelte-izw1xr");
    			add_location(h20, file$7, 20, 0, 756);
    			...
    			add_location(a0, file$7, 23, 4, 934);
    			...
    			add_location(a1, file$7, 24, 4, 1093);
    			...
    			add_location(a2, file$7, 25, 4, 1241);
    			...
    			add_location(a3, file$7, 26, 4, 1393);
    			...
    			add_location(img, file$7, 33, 8, 1731);
    			add_location(picture, file$7, 30, 4, 1559);
    			attr_dev(div1, "class", "headshot svelte-izw1xr");
    			add_location(div1, file$7, 29, 0, 1531);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t33 = text(".");
    			attr_dev(h1, "class", "section-title-intro svelte-twad27");
    			add_location(h1, file$9, 82, 4, 2858);
    			attr_dev(a0, "class", "intro-link svelte-twad27");
    			attr_dev(a0, "href", "https://www.queensu.ca/");
    			attr_dev(a0, "rel", "noreferrer");
    			attr_dev(a0, "target", "_blank");
    			add_location(a0, file$9, 84, 70, 3013);
    			attr_dev(p0, "class", "title-extension svelte-twad27");
    			add_location(p0, file$9, 84, 8, 2951);
    			attr_dev(descriptor0, "class", "svelte-twad27");
    			add_location(descriptor0, file$9, 89, 18, 3512);
    			attr_dev(activity0, "tabindex", "0");
    			attr_dev(activity0, "class", "svelte-twad27");
    			add_location(activity0, file$9, 90, 114, 3804);
    			attr_dev(descriptor1, "class", "svelte-twad27");
    			add_location(descriptor1, file$9, 91, 13, 3905);
    			add_location(p1, file$9, 89, 8, 3502);
    			attr_dev(activity1, "tabindex", "0");
    			attr_dev(activity1, "class", "svelte-twad27");
    			add_location(activity1, file$9, 94, 52, 4301);
    			attr_dev(activity2, "tabindex", "0");
    			attr_dev(activity2, "class", "svelte-twad27");
    			add_location(activity2, file$9, 94, 122, 4371);
    			attr_dev(activity3, "tabindex", "0");
    			attr_dev(activity3, "class", "svelte-twad27");
    			add_location(activity3, file$9, 95, 8, 4442);
    			attr_dev(activity4, "tabindex", "0");
    			attr_dev(activity4, "class", "svelte-twad27");
    			add_location(activity4, file$9, 95, 71, 4505);
    			attr_dev(activity5, "tabindex", "0");
    			attr_dev(activity5, "class", "svelte-twad27");
    			add_location(activity5, file$9, 95, 144, 4578);
    			add_location(p2, file$9, 94, 8, 4257);
    			attr_dev(a1, "class", "intro-link svelte-twad27");
    			attr_dev(a1, "href", "mailto:max.eisen@queensu.ca");
    			attr_dev(a1, "rel", "noreferrer");
    			attr_dev(a1, "target", "_blank");
    			add_location(a1, file$9, 97, 100, 4775);
    			add_location(p3, file$9, 97, 8, 4683);
    			attr_dev(a2, "class", "intro-link svelte-twad27");
    			attr_dev(a2, "href", "/resume");
    			add_location(a2, file$9, 99, 183, 5115);
    			add_location(p4, file$9, 99, 8, 4940);
    			attr_dev(div0, "class", "intro-paragraph svelte-twad27");
    			add_location(div0, file$9, 83, 4, 2912);
    			attr_dev(div1, "class", "intro-container svelte-twad27");
    ...
    function create_default_slot$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$l, 18, 8, 693);
    			attr_dev(div1, "class", "info-section-inner");
    			add_location(div1, file$l, 22, 12, 813);
    			attr_dev(div2, "class", "info-section-main");
    			add_location(div2, file$l, 21, 8, 769);
    			attr_dev(div3, "class", "grid-container");
    			add_location(div3, file$l, 17, 4, 656);
    		},
    		m: function mount(target, anchor) {
