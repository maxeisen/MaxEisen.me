...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div1 = element("div");
    			img = element("img");
    			add_location(h1, file, 4, 0, 81);
    			set_style(b, "color", "#ababab");
    			set_style(b, "font-weight", "300");
    			add_location(b, file, 5, 22, 127);
    			attr_dev(h20, "class", "status svelte-1d3592s");
    			add_location(h20, file, 5, 0, 105);
    			attr_dev(h21, "class", "location svelte-1d3592s");
    			add_location(h21, file, 6, 0, 202);
    			attr_dev(a0, "class", "social-links svelte-1d3592s");
    			attr_dev(a0, "href", "https://linkedin.com/in/maxeisen/");
    			attr_dev(a0, "target", "_blank");
    			add_location(a0, file, 8, 8, 287);
    			add_location(h22, file, 8, 4, 283);
    			attr_dev(a1, "class", "social-links svelte-1d3592s");
    			attr_dev(a1, "href", "https://github.com/maxeisen/");
    			attr_dev(a1, "target", "_blank");
    			add_location(a1, file, 9, 8, 395);
    			add_location(h23, file, 9, 4, 391);
    			attr_dev(a2, "class", "social-links svelte-1d3592s");
    			attr_dev(a2, "href", "https://twitter.com/maxeisen/");
    			attr_dev(a2, "target", "_blank");
    			add_location(a2, file, 10, 8, 496);
    			add_location(h24, file, 10, 4, 492);
    			attr_dev(a3, "class", "social-links svelte-1d3592s");
    			attr_dev(a3, "href", "mailto:max.eisen@queensu.ca");
    			attr_dev(a3, "target", "_blank");
    			add_location(a3, file, 11, 8, 599);
    			add_location(h25, file, 11, 4, 595);
    			attr_dev(div0, "class", "social-links-container svelte-1d3592s");
    			add_location(div0, file, 7, 0, 241);
    			attr_dev(img, "class", "headshot svelte-1d3592s");
    			if (img.src !== (img_src_value = /*headshot*/ ctx[0])) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "Tightly cropped picture of Max");
    			add_location(img, file, 15, 4, 728);
    			attr_dev(div1, "class", "headshot svelte-1d3592s");
    			add_location(div1, file, 14, 0, 700);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a0, "class", "intro-link svelte-19qk49c");
    			attr_dev(a0, "href", "https://www.queensu.ca/");
    			add_location(a0, file$1, 5, 42, 149);
    			add_location(p0, file$1, 5, 4, 111);
    			add_location(p1, file$1, 6, 4, 269);
    			attr_dev(a1, "class", "intro-link svelte-19qk49c");
    			attr_dev(a1, "href", "mailto:max.eisen@queensu.ca");
    			attr_dev(a1, "target", "_blank");
    			add_location(a1, file$1, 7, 82, 624);
    			add_location(p2, file$1, 7, 4, 546);
    			attr_dev(div, "class", "intro-paragraph svelte-19qk49c");
    			add_location(div, file$1, 4, 0, 76);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t9 = space();
    			p = element("p");
    			attr_dev(h1, "class", "modal-position svelte-1xpurze");
    			add_location(h1, file$2, 11, 4, 246);
    			attr_dev(a, "href", /*companyLink*/ ctx[2]);
    			attr_dev(a, "target", "_blank");
    			add_location(a, file$2, 12, 30, 320);
    			attr_dev(h2, "class", "modal-company svelte-1xpurze");
    			add_location(h2, file$2, 12, 4, 294);
    			attr_dev(h30, "class", "modal-description svelte-1xpurze");
    			set_style(h30, "text-align", "center");
    			add_location(h30, file$2, 13, 4, 382);
    			attr_dev(h31, "class", "modal-description svelte-1xpurze");
    			set_style(h31, "text-align", "center");
    			set_style(h31, "color", "#333333");
    			add_location(h31, file$2, 14, 4, 471);
    			attr_dev(p, "class", "modal-description svelte-1xpurze");
    			add_location(p, file$2, 15, 4, 565);
    			attr_dev(div, "class", "experience-modal svelte-1xpurze");
    			add_location(div, file$2, 10, 0, 210);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h10, file$3, 99, 0, 6334);
    			attr_dev(div0, "class", "experience-position svelte-lqrfxp");
    			add_location(div0, file$3, 102, 37, 6520);
    			attr_dev(h20, "class", "experience-title svelte-lqrfxp");
    			add_location(h20, file$3, 102, 8, 6491);
    			attr_dev(h21, "class", "experience-company svelte-lqrfxp");
    			add_location(h21, file$3, 103, 8, 6589);
    			add_location(p0, file$3, 104, 8, 6649);
    			attr_dev(div1, "class", "experience-date svelte-lqrfxp");
    			add_location(div1, file$3, 105, 45, 6726);
    			attr_dev(div2, "class", "experience-location svelte-lqrfxp");
    			add_location(div2, file$3, 105, 111, 6792);
    			attr_dev(h11, "class", "experience-date-location svelte-lqrfxp");
    			add_location(h11, file$3, 105, 8, 6689);
    			attr_dev(div3, "class", "experience-item");
    			add_location(div3, file$3, 101, 4, 6434);
    			attr_dev(div4, "class", "experience-position svelte-lqrfxp");
    			add_location(div4, file$3, 108, 37, 6955);
    			attr_dev(h22, "class", "experience-title svelte-lqrfxp");
    			add_location(h22, file$3, 108, 8, 6926);
    			attr_dev(h23, "class", "experience-company svelte-lqrfxp");
    			add_location(h23, file$3, 109, 8, 7024);
    			add_location(p1, file$3, 110, 8, 7074);
    			attr_dev(div5, "class", "experience-date svelte-lqrfxp");
    			add_location(div5, file$3, 111, 45, 7151);
    			attr_dev(div6, "class", "experience-location svelte-lqrfxp");
    			add_location(div6, file$3, 111, 111, 7217);
    			attr_dev(h12, "class", "experience-date-location svelte-lqrfxp");
    			add_location(h12, file$3, 111, 8, 7114);
    			attr_dev(div7, "class", "experience-item");
    			add_location(div7, file$3, 107, 4, 6869);
    			attr_dev(div8, "class", "experience-position svelte-lqrfxp");
    			add_location(div8, file$3, 114, 37, 7380);
    			attr_dev(h24, "class", "experience-title svelte-lqrfxp");
    			add_location(h24, file$3, 114, 8, 7351);
    			attr_dev(h25, "class", "experience-company svelte-lqrfxp");
    			add_location(h25, file$3, 115, 8, 7449);
    			add_location(p2, file$3, 116, 8, 7509);
    			attr_dev(div9, "class", "experience-date svelte-lqrfxp");
    			add_location(div9, file$3, 117, 45, 7586);
    			attr_dev(div10, "class", "experience-location svelte-lqrfxp");
    			add_location(div10, file$3, 117, 111, 7652);
    			attr_dev(h13, "class", "experience-date-location svelte-lqrfxp");
    			add_location(h13, file$3, 117, 8, 7549);
    			attr_dev(div11, "class", "experience-item");
    			add_location(div11, file$3, 113, 4, 7294);
    			attr_dev(div12, "class", "experience-position svelte-lqrfxp");
    			add_location(div12, file$3, 120, 37, 7815);
    			attr_dev(h26, "class", "experience-title svelte-lqrfxp");
    			add_location(h26, file$3, 120, 8, 7786);
    			attr_dev(h27, "class", "experience-company svelte-lqrfxp");
    			add_location(h27, file$3, 121, 8, 7890);
    			add_location(p3, file$3, 122, 8, 7950);
    			attr_dev(div13, "class", "experience-date svelte-lqrfxp");
    			add_location(div13, file$3, 123, 45, 8027);
    			attr_dev(div14, "class", "experience-location svelte-lqrfxp");
    			add_location(div14, file$3, 124, 8, 8097);
    			attr_dev(h14, "class", "experience-date-location svelte-lqrfxp");
    			add_location(h14, file$3, 123, 8, 7990);
    			attr_dev(div15, "class", "experience-item");
    			add_location(div15, file$3, 119, 4, 7729);
    			attr_dev(div16, "class", "experience-position svelte-lqrfxp");
    			add_location(div16, file$3, 127, 37, 8260);
    			attr_dev(h28, "class", "experience-title svelte-lqrfxp");
    			add_location(h28, file$3, 127, 8, 8231);
    			attr_dev(h29, "class", "experience-company svelte-lqrfxp");
    			add_location(h29, file$3, 128, 8, 8329);
    			add_location(p4, file$3, 129, 8, 8389);
    			attr_dev(div17, "class", "experience-date svelte-lqrfxp");
    			add_location(div17, file$3, 130, 45, 8466);
    			attr_dev(div18, "class", "experience-location svelte-lqrfxp");
    			add_location(div18, file$3, 130, 100, 8521);
    			attr_dev(h15, "class", "experience-date-location svelte-lqrfxp");
    			add_location(h15, file$3, 130, 8, 8429);
    			attr_dev(div19, "class", "experience-item");
    			add_location(div19, file$3, 126, 4, 8174);
    			attr_dev(div20, "class", "experience-position svelte-lqrfxp");
    			add_location(div20, file$3, 133, 37, 8684);
    			attr_dev(h210, "class", "experience-title svelte-lqrfxp");
    			add_location(h210, file$3, 133, 8, 8655);
    			attr_dev(h211, "class", "experience-company svelte-lqrfxp");
    			add_location(h211, file$3, 134, 8, 8753);
    			add_location(p5, file$3, 135, 8, 8813);
    			attr_dev(div21, "class", "experience-date svelte-lqrfxp");
    			add_location(div21, file$3, 136, 45, 8890);
    			attr_dev(div22, "class", "experience-location svelte-lqrfxp");
    			add_location(div22, file$3, 136, 111, 8956);
    			attr_dev(h16, "class", "experience-date-location svelte-lqrfxp");
    			add_location(h16, file$3, 136, 8, 8853);
    			attr_dev(div23, "class", "experience-item");
    			add_location(div23, file$3, 132, 4, 8598);
    			attr_dev(div24, "class", "experience-subsection");
    			add_location(div24, file$3, 100, 0, 6393);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a0, "target", "_blank");
    			add_location(a0, file$4, 11, 27, 267);
    			attr_dev(h1, "class", "modal-name svelte-1es7ks5");
    			add_location(h1, file$4, 11, 4, 244);
    			attr_dev(b, "class", "technologies svelte-1es7ks5");
    			add_location(b, file$4, 12, 75, 406);
    			attr_dev(h3, "class", "modal-description svelte-1es7ks5");
    			set_style(h3, "text-align", "center");
    			add_location(h3, file$4, 12, 4, 335);
    			attr_dev(p, "class", "modal-description svelte-1es7ks5");
    			add_location(p, file$4, 13, 4, 459);
    			attr_dev(img, "class", "screenshot svelte-1es7ks5");
    			...
    			add_location(img, file$4, 14, 4, 517);
    			attr_dev(h2, "class", "github-link svelte-1es7ks5");
    			add_location(h2, file$4, 15, 41, 627);
    			attr_dev(a1, "href", /*githubLink*/ ctx[4]);
    			attr_dev(a1, "target", "_blank");
    			add_location(a1, file$4, 15, 4, 590);
    			attr_dev(div, "class", "project-modal svelte-1es7ks5");
    			add_location(div, file$4, 10, 0, 211);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$5, 73, 0, 4645);
    			html_tag = new HtmlTag(raw0_value, null);
    			attr_dev(h20, "class", "project-name svelte-g2nwxf");
    			add_location(h20, file$5, 76, 8, 4792);
    			attr_dev(h21, "class", "project-year svelte-g2nwxf");
    			add_location(h21, file$5, 77, 8, 4864);
    			attr_dev(h22, "class", "project-tech svelte-g2nwxf");
    			add_location(h22, file$5, 78, 8, 4916);
    			add_location(p0, file$5, 79, 8, 4976);
    			attr_dev(div0, "class", "project-item");
    			add_location(div0, file$5, 75, 4, 4738);
    			html_tag_1 = new HtmlTag(raw1_value, null);
    			attr_dev(h23, "class", "project-name svelte-g2nwxf");
    			add_location(h23, file$5, 82, 8, 5079);
    			attr_dev(h24, "class", "project-year svelte-g2nwxf");
    			add_location(h24, file$5, 83, 8, 5151);
    			attr_dev(h25, "class", "project-tech svelte-g2nwxf");
    			add_location(h25, file$5, 84, 8, 5203);
    			add_location(p1, file$5, 85, 8, 5263);
    			attr_dev(div1, "class", "project-item");
    			add_location(div1, file$5, 81, 4, 5025);
    			html_tag_2 = new HtmlTag(raw2_value, null);
    			attr_dev(h26, "class", "project-name svelte-g2nwxf");
    			add_location(h26, file$5, 88, 8, 5366);
    			attr_dev(h27, "class", "project-year svelte-g2nwxf");
    			add_location(h27, file$5, 89, 8, 5438);
    			attr_dev(h28, "class", "project-tech svelte-g2nwxf");
    			add_location(h28, file$5, 90, 8, 5490);
    			add_location(p2, file$5, 91, 8, 5550);
    			attr_dev(div2, "class", "project-item");
    			add_location(div2, file$5, 87, 4, 5312);
    			html_tag_3 = new HtmlTag(raw3_value, null);
    			attr_dev(h29, "class", "project-name svelte-g2nwxf");
    			add_location(h29, file$5, 94, 8, 5653);
    			attr_dev(h210, "class", "project-year svelte-g2nwxf");
    			add_location(h210, file$5, 95, 8, 5725);
    			attr_dev(h211, "class", "project-tech svelte-g2nwxf");
    			add_location(h211, file$5, 96, 8, 5777);
    			add_location(p3, file$5, 97, 8, 5837);
    			attr_dev(div3, "class", "project-item");
    			add_location(div3, file$5, 93, 4, 5599);
    			attr_dev(div4, "class", "project-subsection");
    			add_location(div4, file$5, 74, 0, 4700);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$6 = "src\\components\\EducationModal.svelte";
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "modal-school svelte-1lfs5fp");
    			add_location(h1, file$6, 9, 4, 180);
    			attr_dev(h2, "class", "modal-degree svelte-1lfs5fp");
    			add_location(h2, file$6, 10, 4, 224);
    			attr_dev(h30, "class", "modal-major svelte-1lfs5fp");
    			set_style(h30, "text-align", "center");
    			add_location(h30, file$6, 11, 4, 274);
    			attr_dev(h31, "class", "modal-years svelte-1lfs5fp");
    			set_style(h31, "text-align", "center");
    			set_style(h31, "color", "#333333");
    			add_location(h31, file$6, 12, 4, 349);
    			add_location(b, file$6, 13, 32, 462);
    			attr_dev(p, "class", "modal-committees svelte-1lfs5fp");
    			add_location(p, file$6, 13, 4, 434);
    			attr_dev(div, "class", "education-modal svelte-1lfs5fp");
    			add_location(div, file$6, 8, 0, 145);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$7, 22, 0, 886);
    			attr_dev(h20, "class", "school-name svelte-1o4h3ti");
    			add_location(h20, file$7, 25, 12, 1059);
    			attr_dev(h21, "class", "degree-info svelte-1o4h3ti");
    			add_location(h21, file$7, 26, 12, 1120);
    			attr_dev(h22, "class", "major-info svelte-1o4h3ti");
    			add_location(h22, file$7, 27, 12, 1194);
    			attr_dev(h23, "class", "degree-years svelte-1o4h3ti");
    			add_location(h23, file$7, 28, 12, 1252);
    			attr_dev(div0, "class", "education-item");
    			add_location(div0, file$7, 24, 8, 991);
    			attr_dev(div1, "class", "education-subsection");
    			add_location(div1, file$7, 23, 4, 947);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(li0, "class", "svelte-1wmcujv");
    			add_location(li0, file$8, 6, 8, 125);
    			attr_dev(li1, "class", "svelte-1wmcujv");
    			add_location(li1, file$8, 7, 8, 150);
    			attr_dev(li2, "class", "svelte-1wmcujv");
    			add_location(li2, file$8, 8, 8, 174);
    			attr_dev(li3, "class", "svelte-1wmcujv");
    			add_location(li3, file$8, 9, 8, 197);
    			attr_dev(li4, "class", "svelte-1wmcujv");
    			add_location(li4, file$8, 10, 8, 226);
    			attr_dev(li5, "class", "svelte-1wmcujv");
    			add_location(li5, file$8, 11, 8, 249);
    			attr_dev(li6, "class", "svelte-1wmcujv");
    			add_location(li6, file$8, 12, 8, 271);
    			attr_dev(li7, "class", "svelte-1wmcujv");
    			add_location(li7, file$8, 13, 8, 293);
    			attr_dev(li8, "class", "svelte-1wmcujv");
    			add_location(li8, file$8, 14, 8, 314);
    			attr_dev(li9, "class", "svelte-1wmcujv");
    			add_location(li9, file$8, 15, 8, 334);
    			attr_dev(li10, "class", "svelte-1wmcujv");
    			add_location(li10, file$8, 16, 8, 356);
    			attr_dev(li11, "class", "svelte-1wmcujv");
    			add_location(li11, file$8, 17, 8, 381);
    			attr_dev(li12, "class", "svelte-1wmcujv");
    			add_location(li12, file$8, 18, 8, 406);
    			attr_dev(li13, "class", "svelte-1wmcujv");
    			add_location(li13, file$8, 19, 8, 430);
    			attr_dev(li14, "class", "svelte-1wmcujv");
    			add_location(li14, file$8, 20, 8, 455);
    			attr_dev(li15, "class", "svelte-1wmcujv");
    			add_location(li15, file$8, 21, 8, 477);
    			attr_dev(ul, "class", "svelte-1wmcujv");
    			add_location(ul, file$8, 5, 4, 111);
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$9, 232, 12, 5350);
    		},
    		m: function mount(target, anchor, remount) {
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$9, 212, 0, 4769);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$a, 16, 29, 563);
    			attr_dev(a0, "href", "/#");
    			add_location(a0, file$a, 16, 16, 550);
    			add_location(div0, file$a, 15, 12, 527);
    			attr_dev(a1, "href", "#experience");
    			add_location(a1, file$a, 21, 28, 788);
    			add_location(li0, file$a, 21, 24, 784);
    			attr_dev(a2, "href", "#projects");
    			add_location(a2, file$a, 22, 28, 859);
    			add_location(li1, file$a, 22, 24, 855);
    			attr_dev(a3, "href", "#education");
    			add_location(a3, file$a, 23, 28, 926);
    			add_location(li2, file$a, 23, 24, 922);
    			attr_dev(a4, "href", "#skills");
    			add_location(a4, file$a, 24, 28, 995);
    			add_location(li3, file$a, 24, 24, 991);
    			add_location(b0, file$a, 25, 46, 1076);
    			attr_dev(a5, "href", "/resume");
    			add_location(a5, file$a, 25, 28, 1058);
    			add_location(li4, file$a, 25, 24, 1054);
    			add_location(ul, file$a, 20, 20, 754);
    			add_location(nav, file$a, 19, 16, 727);
    			attr_dev(div1, "class", "nav-bar");
    			add_location(div1, file$a, 18, 12, 688);
    			add_location(header, file$a, 14, 8, 505);
    			attr_dev(div2, "class", "sidebar-section");
    			add_location(div2, file$a, 31, 12, 1240);
    			attr_dev(div3, "class", "info-section-inner");
    			add_location(div3, file$a, 35, 16, 1380);
    			set_style(b1, "font-size", "14px");
    			set_style(b1, "color", "#ababab");
    			add_location(b1, file$a, 42, 124, 1725);
    			attr_dev(h2, "class", "footer");
    			add_location(h2, file$a, 42, 74, 1675);
    			attr_dev(a6, "href", "https://github.com/maxeisen/maxeisen.github.io/");
    			add_location(a6, file$a, 42, 16, 1617);
    			attr_dev(div4, "class", "info-section-main");
    			add_location(div4, file$a, 34, 12, 1331);
    			attr_dev(div5, "class", "grid-container");
    			add_location(div5, file$a, 30, 8, 1198);
    			add_location(body, file$a, 13, 4, 489);
    			attr_dev(html, "lang", "en");
    			add_location(html, file$a, 12, 0, 467);
    		},
    		m: function mount(target, anchor) {
